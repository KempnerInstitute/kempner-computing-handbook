...
- **Track utilization.** Model FLOPs Utilization (MFU) measures how much of the GPU's peak you actually use, and is the headline efficiency metric for large runs. For detailed profiling, see {doc}`GPU Profiling <../scalability/gpu_profiling>`.
